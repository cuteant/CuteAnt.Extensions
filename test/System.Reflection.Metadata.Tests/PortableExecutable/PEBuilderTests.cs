    ...
    public class PEBuilderTests
    {
        ...
        public void ChecksumFXAssemblies()
        {
            var paths = new[]
            {
                ...
                typeof(Linq.Expressions.Expression).Assembly.Location,
                typeof(ComponentModel.EditorBrowsableAttribute).Assembly.Location,
                typeof(IEnumerable<>).Assembly.Location,
                typeof(Text.Encoding).Assembly.Location,
                typeof(Threading.Tasks.Task).Assembly.Location,
                typeof(IO.MemoryMappedFiles.MemoryMappedFile).Assembly.Location,
                typeof(Diagnostics.Debug).Assembly.Location,
                typeof(ImmutableArray).Assembly.Location,
                typeof(Text.RegularExpressions.Regex).Assembly.Location,
                typeof(Threading.Tasks.ParallelLoopResult).Assembly.Location,
            };
