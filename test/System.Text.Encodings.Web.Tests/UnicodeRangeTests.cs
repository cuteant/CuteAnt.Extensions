...
namespace Microsoft.Framework.WebEncoders
{
    public class UnicodeRangeTests
    {
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>("firstCodePoint", () => new UnicodeRange(firstCodePoint, rangeSize));
        }
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>("length", () => new UnicodeRange(firstCodePoint, rangeSize));
        }
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>("lastCharacter", () => UnicodeRange.Create('\u0020', '\u0010'));
        }
