  ...
  public class ListAdapter : IAdapter
  {
    ...
    private bool TryGetListTypeArgument(IList list, out Type listTypeArgument, out string errorMessage)
    {
      ...
      else
      {
        ...
        {
          var genericArguments = genericList.IsGenericType && !genericList.IsGenericTypeDefinition ? genericList.GetGenericArguments() : Type.EmptyTypes;
          listTypeArgument = genericArguments[0];
          errorMessage = null;
          return true;
        }
      }
