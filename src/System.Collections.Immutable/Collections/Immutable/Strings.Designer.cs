...
namespace System.Collections.Immutable {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   查找类似 The given key &apos;{0}&apos; was not present in the dictionary. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Object is not an array with the same initialization state as the array to compare it to. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Object is not an array with the same number of elements as the array to compare it to. 的本地化字符串。
        /// </summary>
